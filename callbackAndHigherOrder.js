...
const contains = (arr, personName, callback4) =>{ 
 if(arr.includes(personName)){callback4(true)}else{
   callback4(false)
 }
}
...
const each = (arr, callback6) => {
arr.forEach(callback6)  
}

const callback6 = (item, index) => console.log(`the item at the index ${index} is ${item}`)
/*
...
const addingFactory = (n) => y => n + y
const addTen =addingFactory(10)
console.log(addTen(5))
console.log(addTen(450349))
